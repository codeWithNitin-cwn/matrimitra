      ...
      {selectedProfileId ? (
        <div className="space-y-10">
          {isLoadingMatches ? (
            ...
            <div className="text-center py-20 text-red-600">Failed to evaluate matches. Check API health.</div>
              ...
              {(() => {
                ...
                return (
                  <div className="space-y-4">
                    ...
                    {/* Summary */}
                    <p className="text-xs text-gray-750 leading-relaxed font-medium">
                  ...
                  return (
                    <div key={trait.key} className="flex justify-between items-center border-b pb-1">
                      ...
                      <div className="flex gap-x-3">
                        ...
                        <span className="text-indigo-600">Them: <strong>{candidateVal}/10</strong></span>
                      </div>
                    </div>
                  );
                })}
