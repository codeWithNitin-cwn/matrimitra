  ...
  return (
    <div className="container mx-auto pb-12">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-y-4 mb-6 border-b border-gray-200 pb-5">
        <div className="flex items-center gap-x-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">MatriMitra Scoped Tenant Intelligence Dashboard</p>
          </div>
        </div>
      ...
      {isLoadingStats ? (
        ...
        <div className="text-center py-20 text-red-600 font-semibold bg-white border border-gray-200 rounded-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 px-6 pt-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col justify-between">
              ...
              <div className="flex flex-col items-center py-6">
                <span className="text-5xl font-extrabold text-indigo-600">{stats.followUpCompletionRate || 0}%</span>
                    ...
                    {stats.todaysFollowUps && stats.todaysFollowUps.length > 0 ? (
                      stats.todaysFollowUps.map((f: any) => (
                        <tr key={f.id} className="hover:bg-gray-50">
                          <td className="py-2">
                            <span className="font-semibold text-indigo-600 block">{f.profileNumber}</span>
                          ...
                          <td className="py-2">
                            <span className={`inline-flex items-center rounded-md px-1.5 py-0.5 text-[10px] font-medium ${
                              ...
                              f.priority === 'MEDIUM' ? 'bg-yellow-50 text-yellow-800 ring-1 ring-inset ring-yellow-600/15' :
                              'bg-gray-50 text-gray-600 ring-1 ring-inset ring-gray-550/10'
                            }`}>
                              {f.priority}
                            </span>
                          </td>
                  ...
                  <tbody className="divide-y divide-gray-100 text-gray-700">
                    {stats.overdueFollowUps && stats.overdueFollowUps.length > 0 ? (
                      stats.overdueFollowUps.map((f: any) => (
                        <tr key={f.id} className="hover:bg-gray-50">
                          <td className="py-2">
                            <span className="font-semibold text-red-600 block">{f.profileNumber}</span>
                            <span className="text-gray-500">{f.name}</span>
                          </td>
                          <td className="py-2">
                            <span className={`inline-flex items-center rounded-md px-1.5 py-0.5 text-[10px] font-medium ${
