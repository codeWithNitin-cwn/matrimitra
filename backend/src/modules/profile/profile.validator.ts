...
export const createDraftProfileSchema = z.object({
  ...
  clientId: z.string().uuid().optional().or(z.literal("")).nullable(),
  profileType: z.string().optional(),
  relationshipToClient: z.string().optional().nullable(),
  weightKg: z.string().or(z.number()).optional(),
  ...
  siblingsCount: z.string().or(z.number()).optional(),
  familyType: z.string().optional(),
  familyValues: z.string().optional(),
  castePreference: z.string().optional(),
  religionPreference: z.string().optional(),
  cityPreference: z.string().optional(),
  professionPreference: z.string().optional(),
  agePriority: z.string().optional(),
  castePriority: z.string().optional(),
  religionPriority: z.string().optional(),
  heightPriority: z.string().optional(),
  cityPriority: z.string().optional(),
  educationPriority: z.string().optional(),
  professionPriority: z.string().optional(),
  foodHabit: z.string().optional(),
  smoking: z.string().or(z.boolean()).optional(),
  drinking: z.string().or(z.boolean()).optional(),
  fitnessLevel: z.string().optional(),
  hobbies: z.string().optional(),
  questionAnswers: z.any().optional(),
  photoPrimary: z.string().optional(),
